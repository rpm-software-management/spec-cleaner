...
The code of spec-cleaner is formatted with [Ruff](https://github.com/astral-sh/ruff). We use single quotes and `--line-length 100`. Ruff runs automatically in the `pre-commit` hook and is enforced in CI.
